...
export class CourselistComponent implements OnInit  {
  ...
  googlemeetcourselist!: Observable<Course[]>;
liveclasscourselist!: Observable<Course[]>;
 ...
 ngOnInit() 
 {
  ...
  $("#googlemeetcoursecard").css('display','block');
$("#liveclasscoursecard").css('display','block');
  $("#likedbtn").hide();
  $("#enrollsuccess").hide();
  ...
  $("#googlemeetcard").click(function(){
  $("#youtubecoursecard").css('display','none');
  $("#websitecoursecard").css('display','none');
  $("#googlemeetcoursecard").css('display','none');
  $("#liveclasscoursecard").css('display','none');
  $("#coursedetailscard").show();
});

$("#liveclasscard").click(function(){
  $("#youtubecoursecard").css('display','none');
  $("#websitecoursecard").css('display','none');
  $("#googlemeetcoursecard").css('display','none');
  $("#liveclasscoursecard").css('display','none');
...
enrollcourse(course : Course, loggedUser : string, currRole : string)
{
  ...
  this.enrollment.googleMeetLink = course.googleMeetLink;
this.enrollment.liveClassLink = course.liveClassLink;
